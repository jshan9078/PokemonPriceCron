-- =====================================================
-- Ensure Price History Stores Only Numeric Values
-- =====================================================
-- This migration ensures that the batch_update_price_history function
-- ONLY stores numeric market prices in price_history, not objects
...
COMMENT ON FUNCTION batch_update_price_history IS 'Batch updates price history (NUMERIC VALUES ONLY) with UPSERT support and low/high price tracking';
